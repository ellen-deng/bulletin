...
(15, 6, 1, '大雨沖刷 雲林二崙大義崙大排護岸崩塌', '雲林縣二崙鄉大義崙大排護岸疑因大雨沖刷，今天出現約10多公尺崩塌，避免危及防汛道路安全，縣府已拉起封鎖線，請民眾改道，同時已通知廠商搶修。\r\n\r\n二崙鄉大義崙大排埤塘寶塔旁護岸不敵昨天滂沱大雨崩塌，不僅護欄掉落河中，防汛道路路基與柏油也都出現沖蝕，由於氣象預報這幾天仍有可能發生大雨，居民憂心崩塌情況擴大，危及鄰近地區安全，要求縣府趕緊搶修。\r\n\r\n縣府水利處長許宏博表示，縣府接獲通報已派員前往勘查，於防汛道路入口處拉封鎖線，請民眾不要通行，以免發生危險，也通知廠商儘速完成搶修。', '2019-08-14 07:51:09', '2019-08-14 09:33:57');
...
--
ALTER TABLE `member`
  MODIFY `member_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
